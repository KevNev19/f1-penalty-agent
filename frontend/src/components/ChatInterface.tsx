                ...
                <div className="flex items-center gap-3">
                    {messages.length > 0 && (
                        <button
                            ...
                            className="text-[10px] font-bold uppercase tracking-wide text-white/70 hover:text-white bg-black/30 hover:bg-black/50 px-2 py-1 rounded transition-colors"
